...
const Contacts = () => {
  return (
    <div id='contacts_container' className='text-center mb-5'>
      <div className='fs-2 fw-bold mb-5'>{'< Contacts />'}</div>
      <div className='mx-5 '>
        <div>
          <div className='fs-4 mb-4'>If you like what I do, contact me!</div>
          <img src={email} alt="" />
        </div>
        <div className='d-flex justify-content-around flex-wrap mt-5'>
          <a className='hover_orange contact_link btn btn-dark d-flex align-items-center justify-content-center' href="mailto:alessio.conte.dev@gmail.com?subject=ciao">
            <div>Email</div>
